...
let sum = student.filter((item, index, aaray) => {
    let {money}= item
...
//#endregion
/*todo:
   1.Сделать функцию, которая отчисляет двоечников (done)
   2.Сделать функцию которая отбирает годных для армии (done)
   3.Сделать функцию которая считает сумму денег студентов (in progress)
